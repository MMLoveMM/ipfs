...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>长春市科技金融服务平台 - 个人客户资产负债信息</title>
	...
	<body class="no-skin">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content" style="position: relative;">
						...
						<form action="" method="POST" name="asset_form" id="assetForm" onsubmit="return false" class="form-horizontal" > 
							<div class="col-xs-5">
						...
						<input type="hidden" id="houseType" value='${tDataDicts}'>
		...
		<script type="text/javascript" src="${appCtx}/static/busi/report/person_assetMsg.js"></script>
	</body>
</html>
