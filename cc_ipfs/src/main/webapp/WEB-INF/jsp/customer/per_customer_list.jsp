...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>长春市科技金融服务平台 - 个人客户信息报表</title>
					...
					<div class="page-content" style="position: relative;">
						...
						<form action="" method="POST" name="search_form" id="searchForm" onsubmit="return false" class="form-horizontal" > 
							...
							<div class="col-xs-5">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="pernum"
											name="pernum" autocomplete="off">
									</div>
								</div>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<table id="mainGrid-table"></table>

								<div id="mainGrid-pager"></div>
