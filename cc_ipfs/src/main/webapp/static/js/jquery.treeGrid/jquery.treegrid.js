...
(function($) {
    ...
    var methods = {
        ...
        getAllChildNodes: function() {
            return $(this).treegrid('getSetting', 'getAllChildNodes').apply(this, [$(this).treegrid('getNodeId'), $(this).treegrid('getTreeContainer')]);
        },

        getAllChildNodesId: function() {
            return $(this).treegrid('getSetting', 'getAllChildNodesId').apply(this, [$(this).treegrid('getNodeId'), $(this).treegrid('getTreeContainer')]);
        },

        _recursive: function(id, treegridContainer, nodes) {
            return $(this).treegrid('getSetting', '_recursive').apply(this, [id, treegridContainer, nodes]);
        },
        /**
    ...
    $.fn.treegrid.defaults = {
        ...
        getAllChildNodes: function(id, treegridContainer) {
            var nodes = new Array();
            function _recursive(id, treegridContainer, nodes){
                var templateClass = "treegrid-parent-" + id;
                $.each(treegridContainer.find('tr.' + templateClass),function(){
                    nodes.push($(this));
                    _recursive($(this).attr("id").replace('node_', ''), treegridContainer, nodes);
                });
            }
            _recursive(id,treegridContainer, nodes);
            return $(nodes);
        },
        getAllChildNodesId: function(id, treegridContainer) {
            var nodes = new Array();
            function _recursive(id, treegridContainer, nodes){
                var templateClass = "treegrid-parent-" + id;
                nodes.push(id);
